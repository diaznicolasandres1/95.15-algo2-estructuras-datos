...
static void prueba_crear_hash_vacio()
{
	...
	printf("=====INICIO PRUEBAS CREAR HASH VACIO=====\n");
    ...
    hash_destruir(hash);
    printf("=====FIN PRUEBAS CREAR HASH VACIO=====\n");
}

static void prueba_iterar_hash_vacio()
{
	printf("=====INICIO PRUEBAS ITERAR HASH VACIO=====\n");
    hash_t* hash = hash_crear(NULL);
...
{
	printf("=====INICIO PRUEBAS HASH INSERTAR=====\n");
    hash_t* hash = hash_crear(NULL);
    ...
    hash_destruir(hash);
    printf("=====FIN PRUEBAS iNSERTAR HASH=====\n");
}

static void prueba_hash_reemplazar()
{
	printf("=====INICIO PRUEBAS REEMPLAZAR=====\n");
    hash_t* hash = hash_crear(NULL);
    ...
    hash_destruir(hash);
    printf("=====FIN PRUEBAS REEMPLAZAR=====\n");
}

static void prueba_hash_reemplazar_con_destruir()
{
	printf("=====INICIO PRUEBAS REEMPLAZAR CON DESTRUIR=====\n");
    ...
    hash_destruir(hash);
    printf("=====FIN PRUEBAS REEMPLAZAR CON DESTRUIR=====\n");
}

static void prueba_hash_borrar()
{
	printf("=====INICIO PRUEBAS HASH BORRAR=====\n");
    hash_t* hash = hash_crear(NULL);
    ...
    hash_destruir(hash);
    	printf("=====FIN PRUEBAS HASH BORRAR=====\n");
}

static void prueba_hash_clave_vacia()
{
		printf("=====INICIO PRUEBAS HASH CLAVE VACIA=====\n");
    hash_t* hash = hash_crear(NULL);
    ...
    hash_destruir(hash);
    	printf("=====FIN PRUEBAS HASH CLAVE VACIA=====\n");
}

static void prueba_hash_valor_null()
{
	printf("=====INICIO PRUEBAS HASH VALOR NULL=====\n");
    hash_t* hash = hash_crear(NULL);
    ...
    hash_destruir(hash);
		printf("=====FIN PRUEBAS HASH VALOR NULL=====\n");
}

static void prueba_hash_volumen(size_t largo, bool debug)
{
		printf("=====INICIO PRUEBAS HASH VOLUMEN=====\n");
    hash_t* hash = hash_crear(NULL);
    ...
    hash_destruir(hash);
	printf("=====fin PRUEBAS HASH VLUMEN=====\n");
}
...
{
	printf("=====INICIO PRUEBAS HASH ITERAR=====\n");
    hash_t* hash = hash_crear(NULL);
    ...
    hash_iter_destruir(iter);
    hash_destruir(hash);
    	printf("=====FIN PRUEBAS HASH ITERAR=====\n");
}

static void prueba_hash_iterar_volumen(size_t largo)
{
	printf("=====INICIO PRUEBAS HASH ITERAR VOLUMEN=====\n");
    hash_t* hash = hash_crear(NULL);
    ...
    hash_iter_destruir(iter);
    hash_destruir(hash);
   	printf("=====FIN PRUEBAS HASH ITERAR VOLUMEN=====\n");
}
